...
class ServerlessEnvGeneratorPlugin {
    constructor(serverless, options) {
        ...
        if (config.packageEnvFile) {
            this.hooks["before:package:initialize"] = this.writeDotEnvFile.bind(this)
            this.hooks["after:package:finalize"] = this.removeDotEnvFile.bind(this)
        }
    }
    ...
    getConfig() {
        if (!this.config) {
            ...
            this.config = {
                ...
                packageEnvFile: this.serverless.service.custom.packageEnvFile
            };
        }
        return this.config;
    }
